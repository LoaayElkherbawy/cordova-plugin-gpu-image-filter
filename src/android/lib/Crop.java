...
public class Crop {
     ...
     */
    public static Crop of(Bitmap source, Bitmap destination) {
        return new Crop(source, destination);
    }

    private Crop(Bitmap source, Bitmap destination) {
        cropIntent = new Intent();
        Bundle bundle = new Bundle();
        bundle.putParcelable("SOURCE",source);
//        cropIntent.putExtra(MediaStore.EXTRA_OUTPUT, destination);
        cropIntent.putExtra("SOURCE_BUNDLE", bundle);
    }
     ...
     */
    public static Bitmap getOutput(Intent result) {
